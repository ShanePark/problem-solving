...
/**
 * BFS
 * Runtime 60 ms Beats 90.91% of users with Java
 */
public class Q752OpenTheLock2 {
    ...
    public int openLock(String[] deadends, String target) {
        ...
        int targetN = Integer.parseInt(target);
        ...
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < qSize; i++) {
                ...
                int n3 = parse(poll[2]);
                int n4 = parse(poll[3]);
                int n = n1 * 1000 + n2 * 100 + n3 * 10 + n4;
                if (!visited.add(n) || forbidden.contains(n)) {
                    continue;
                }
                if (n == targetN) {
                    return step;
                }
                q.offer(new int[]{n1 - 1, n2, n3, n4});
                q.offer(new int[]{n1 + 1, n2, n3, n4});
                q.offer(new int[]{n1, n2 - 1, n3, n4});
                q.offer(new int[]{n1, n2 + 1, n3, n4});
                q.offer(new int[]{n1, n2, n3 - 1, n4});
                q.offer(new int[]{n1, n2, n3 + 1, n4});
                q.offer(new int[]{n1, n2, n3, n4 - 1});
                q.offer(new int[]{n1, n2, n3, n4 + 1});
            }
            step++;
        }
