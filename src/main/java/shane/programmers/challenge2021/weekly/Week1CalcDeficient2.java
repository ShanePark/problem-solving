...
테스트 22 〉	통과 (0.02ms, 53.5MB)
테스트 23 〉	통과 (0.02ms, 52.3MB)
채점 결과
정확성: 95.7
합계: 95.7 / 100.0
 */
public class Week1CalcDeficient2 {

	public static void main(String[] args) {
		Week1CalcDeficient2 solution = new Week1CalcDeficient2();
