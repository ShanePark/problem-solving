...
public class Q126WordLadderII4 {
    ...
    public void test() {
        ...
        assertThat(findLadders("a", "c", List.of("a", "b", "c"))).containsExactlyInAnyOrderElementsOf(STool.convertToStringList("[[\"a\",\"c\"]]"));
        assertThat(findLadders("hit", "cog", List.of("hot", "dot", "dog", "lot", "log", "cog"))).containsExactlyInAnyOrderElementsOf(STool.convertToStringList("[[\"hit\",\"hot\",\"dot\",\"dog\",\"cog\"],[\"hit\",\"hot\",\"lot\",\"log\",\"cog\"]]"));
        assertThat(findLadders("hit", "cog", List.of("hot", "dot", "dog", "lot", "log"))).containsExactlyInAnyOrderElementsOf(STool.convertToStringList("[]"));
    }
