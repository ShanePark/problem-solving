 ...
 * TLE
 */
public class Q1284MinimumNumberOfFlipsToConvertBinaryMatrixToZeroMatrix {

    @Test
    public void test() {
        // TLE : 1 sec 779ms  play++ = 623530
...
//        assertThat(minFlips(STool.convertToIntArray("[[1,0,0],[1,0,0]]"))).isEqualTo(-1);
    ...
    public void testToArr() {
        assertThat(toArr(0, 2, 2)).isDeepEqualTo(new int[][]{{0, 0}, {0, 0}});
        assertThat(toArr(15, 2, 2)).isDeepEqualTo(new int[][]{{1, 1}, {1, 1}});
        assertThat(toArr(8, 2, 2)).isDeepEqualTo(new int[][]{{1, 0}, {0, 0}});
    }
