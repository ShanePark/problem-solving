...
public class Q1584MinCostToConnectAllPoints {
    ...
    public void test() {
        ...
        assertThat(minCostConnectPoints(Ps.intArray("[[-14,-14],[-18,5],[18,-10],[18,18],[10,-2]]"))).isEqualTo(102);
        assertThat(minCostConnectPoints(Ps.intArray("[[11,-6],[9,-19],[16,-13],[4,-9],[20,4],[20,7],[-9,18],[10,-15],[-15,3],[6,6]]"))).isEqualTo(113);
    }
