...
public class Q1268SearchSuggestionsSystem {
    ...
    @Test
    public void test() {
        assertThat(suggestedProducts(new String[]{"mobile", "mouse", "moneypot", "monitor", "mousepad"}, "mouse")).isEqualTo(Ps.strList("[\n" +
        ...
        assertThat(suggestedProducts(
                ...
                Ps.strList("[[\"havana\"],[\"havana\"],[\"havana\"],[\"havana\"],[\"havana\"],[\"havana\"]]")
        );
        ...
        assertThat(suggestedProducts(
                ...
                Ps.strList("[[\"baggage\",\"bags\",\"banner\"],[\"baggage\",\"bags\",\"banner\"],[\"baggage\",\"bags\"],[\"bags\"]]")
        );
        ...
        assertThat(suggestedProducts(
                ...
                Ps.strList("[[\"tkruiswrcbzsbkwbhhvjzzuuiayqzbxjosjssacislcvbtcojpmyatkfgyx\",\n" +
