...
public class Q378KthSmallestElementInASortedMatrix2 {
    ...
    @Test
    public void test() {
        assertThat(kthSmallest(STool.convertToIntArray("[[-5,-4],[-5,-4]]"), 2)).isEqualTo(-5);
        assertThat(kthSmallest(STool.convertToIntArray("[[1,5,9],[10,11,13],[12,13,15]]"), 8)).isEqualTo(13);
        assertThat(kthSmallest(STool.convertToIntArray("[[-5]]"), 1)).isEqualTo(-5);
    }
