...
public class Q1202SmallestStringWithSwaps5 {
    ...
    @Test
    public void test() {
        assertThat(smallestStringWithSwaps("otilzqqoj", STool.convertToIntList("[[2,3],[7,3],[3,8],[1,7],[1,0],[0,4],[0,6],[3,4],[2,5]]"))).isEqualTo("ijlooqqtz");
        ...
        assertThat(smallestStringWithSwaps("judyyek", STool.convertToIntList("[[3,3],[3,0],[5,1],[3,1],[3,4],[3,5]]"))).isEqualTo("ejduyyk");
    }
