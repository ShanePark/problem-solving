...
public class Q417PacificAtlanticWaterFlow {
    ...
    @Test
    public void test() {
        assertThat(pacificAtlantic(Ps.intArray("[[1,2,3],[8,9,4],[7,6,5]]")))
                .isEqualTo(Ps.intList("[[0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]]"));
        assertThat(pacificAtlantic(Ps.intArray("[[1,2,2,3,5],[3,2,3,4,4],[2,4,5,3,1],[6,7,1,4,5],[5,1,1,2,4]]")))
                .isEqualTo(Ps.intList("[[0,4],[1,3],[1,4],[2,2],[3,0],[3,1],[4,0]]"));
        assertThat(pacificAtlantic(Ps.intArray("[[1]]")))
                .isEqualTo(Ps.intList("[[0,0]]"));
    }
